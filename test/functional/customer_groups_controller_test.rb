...
class CustomerGroupsControllerTest < ActionController::TestCase
  ...
  test "should create customer_group" do
    assert_difference('CustomerGroup.count') do
      post :create, customer_group: { description: @customer_group.description, formula: @customer_group.formula, initial: @customer_group.initial, name: @customer_group.name, selected_price: @customer_group.selected_price }
    end
  ...
  test "should update customer_group" do
    put :update, id: @customer_group, customer_group: { description: @customer_group.description, formula: @customer_group.formula, initial: @customer_group.initial, name: @customer_group.name, selected_price: @customer_group.selected_price }
    assert_redirected_to customer_group_path(assigns(:customer_group))
  end
